...
void main() {
  ...
  group('LedroneApiClient', () {
    late http.Client httpClient;
    late LedroneApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = LedroneApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => LedroneApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = LedroneApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws LedroneApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<LedroneApiMalformedResponse>()),
        );
      });

      test(
          'throws LedroneApiRequestFailure '
