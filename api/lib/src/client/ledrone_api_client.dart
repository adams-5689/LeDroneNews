...
import 'package:ledrone_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template ledrone_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class LedroneApiMalformedResponse implements Exception {
  /// {@macro ledrone_api_malformed_response}
  const LedroneApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template ledrone_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class LedroneApiRequestFailure implements Exception {
  /// {@macro ledrone_api_request_failure}
  const LedroneApiRequestFailure({
...
/// {@template ledrone_api_client}
/// A Dart API client for the ledrone API.
/// {@endtemplate}
class LedroneApiClient {
  /// Create an instance of [LedroneApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro ledrone_api_client}
  LedroneApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw LedroneApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        LedroneApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
